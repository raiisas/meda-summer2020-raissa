...
bird["Where does it live"] = "in a tree";
bird.whereItLives "in a tree";
delete bird.color; // delete is a keyword to get or something in the object


bird.quote; // inspecting the object to get information from the values
