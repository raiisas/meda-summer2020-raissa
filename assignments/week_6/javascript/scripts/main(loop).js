...
var employmentCount = 13;

for (var i = 0; i < 10; i = i + 1) {
    console.log("Employee Number 1")

    var text = "Employee Number" + (i + i);
    console.log("Employee Number");
}

// To ask question the computer, use an if statement

for (var i = 0; i < 20; i = i + 1) {

    var text = "loop number" + (i + i);
...
// This loop runs for 10 times only compared to 20 from the previous loop, because we're getting to 20 twice as fast.
console.log("Second loop");
far (var 1 = 0; i < 20; i = i + 1) {
